...
class AdminDeliveryNoteController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $deliveryNotes = DeliveryNote::with('quotation')
            ->orderBy('created_at', 'desc')
            ->paginate(10);
        
        $totalDeliveryNotes = DeliveryNote::count();
        
        // Get available quotations for creating new delivery notes
        $availableQuotations = Quotation::whereDoesntHave('deliveryNote')
            ->orderBy('created_at', 'desc')
            ->get();
        ...
        return view('admin.delivery-note.index', compact(
            'deliveryNotes', 
            'totalDeliveryNotes', 
            'company',
            'availableQuotations',
    ...
    public function destroy(DeliveryNote $deliveryNote)
    {
        ...
        return redirect()->route('admin.delivery-note.index')->with('success','Delivery note deleted successfully!');
    ...
    public function download(DeliveryNote $deliveryNote)
    {
        ...
        $pdf = PDF::loadView('admin.delivery-note.pdf', compact('deliveryNote'))
