                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="{{ route('company.invoice.download', $invoice) }}" 
    ...
    <div class="modal fade" id="createInvoiceModal" tabindex="-1" aria-labelledby="createInvoiceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('company.invoice.store') }}" method="POST" id="createInvoiceForm">
                    @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('company.invoice.print', $invoice) }}" 
    ...
    <div class="modal fade" id="editInvoiceModal{{ $invoice->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('company.invoice.update', $invoice) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row">
    ...
    <div class="modal fade" id="recordPaymentModal{{ $invoice->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('company.invoice.record-payment', $invoice) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="deleteInvoiceModal{{ $invoice->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <form action="{{ route('company.invoice.destroy', $invoice) }}" method="POST">
                        @csrf
                        @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (createModal) {
                createModal.addEventListener('show.bs.modal', function() {
                    ...
                    fetch('{{ route("company.invoice.generate") }}')
