...
<body>
    <div class="container">
        ...
        <div class="company-info">
            <h3>{{ Auth::user()->name ?? 'Your Company Name' }}</h3>
            <p class="mb-0">{{ $company->address ?? 'Company Address' }}</p>
            <p class="mb-0">Phone: {{ $company->phone ?? 'N/A' }} | Email: {{ $company->email ?? 'N/A' }}</p>
            @if($company->vat_number)
            <p class="mb-0">VAT Number: {{ $company->vat_number }}</p>
            @endif
        </div>
        ...
        <div class="footer">
            ...
            <p>{{ Auth::user()->name ?? 'Your Company' }} | {{ $company->address ?? '' }}</p>
