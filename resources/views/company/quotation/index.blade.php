                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="btn-group" role="group">
                          ...
                          <a href="{{ route('company.quotation.download', $quotation) }}" 
  ...
  <div class="modal fade" id="createQuotationModal" tabindex="-1" aria-labelledby="createQuotationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{ route('company.quotation.store') }}" method="POST" id="createQuotationForm">
          @csrf
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{ route('company.quotation.print', $quotation) }}" 
             class="btn btn-primary" target="_blank">
            <i class="material-symbols-rounded">print</i> Print
          </a>
          <a href="{{ route('company.quotation.download', $quotation->id) }}" 
  ...
  <div class="modal fade" id="editQuotationModal{{ $quotation->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="POST" action="{{ route('company.quotation.update', $quotation) }}">
          @csrf
          @method('PUT')
          <div class="modal-body">
            <div class="row">
  ...
  <div class="modal fade" id="deleteQuotationModal{{ $quotation->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
          <form method="POST" action="{{ route('company.quotation.destroy', $quotation) }}" class="d-inline">
            @csrf
            @method('DELETE')
