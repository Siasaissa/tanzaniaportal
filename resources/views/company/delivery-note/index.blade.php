                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="btn-group" role="group">
                          ...
                          <a href="{{ route('company.delivery-note.download', $note) }}" 
                    ...
                    <div class="modal fade" id="editDeliveryNoteModal{{ $note->id }}" tabindex="-1" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ route('company.delivery-note.update', $note) }}" method="POST">
                            @csrf
                            @method('PUT')
  ...
  <div class="modal fade" id="createDeliveryNoteModal" tabindex="-1" aria-labelledby="createDeliveryNoteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{ route('company.delivery-note.store') }}" method="POST" id="createDeliveryNoteForm">
          @csrf
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
   ...
   @foreach ( $deliveryNotes as $note)
    ...
    <div class="modal fade" id="viewDeliveryNoteModal{{ $note->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <a href="{{ route('company.delivery-note.print', $note) }}" 
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (createModal) {
        createModal.addEventListener('show.bs.modal', function() {
          ...
          fetch('{{ route("company.delivery-note.generate") }}')
