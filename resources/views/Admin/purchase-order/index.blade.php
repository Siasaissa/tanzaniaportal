                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="btn-group" role="group">
                          ...
                          @endif
                          <a href="{{ route('admin.purchase-order.download', $po) }}" 
  ...
  <div class="modal fade" id="createPurchaseOrderModal" tabindex="-1" aria-labelledby="createPurchaseOrderModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{ route('admin.purchase-order.store') }}" method="POST" id="createPOForm">
          @csrf
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="{{ route('admin.purchase-order.print', $po) }}" class="btn btn-primary" target="_blank">
              <i class="material-symbols-rounded">print</i> Print
            </a>
            <a href="{{ route('admin.purchase-order.download', $po) }}" class="btn btn-success">
    ...
    <div class="modal fade" id="approvePOModal{{ $po->id }}" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('admin.purchase-order.status.update', $po) }}" method="POST">
            @csrf
            <div class="modal-body">
    ...
    <div class="modal fade" id="deletePOModal{{ $po->id }}" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
            <form action="{{ route('admin.purchase-order.destroy', $po) }}" method="POST" class="d-inline">
              @csrf
              @method('DELETE')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function generatePONumber() {
        ...
        fetch('{{ route("admin.purchase-order.generate") }}')
          .then(response => {
            if (!response.ok) {
